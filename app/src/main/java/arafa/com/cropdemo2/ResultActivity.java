...
/**
 * Created by mohamed.arafa on 3/5/2018.
 */
...
public class ResultActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            int mMaxBitmapSize = BitmapLoadUtils.calculateMaxBitmapSize(this);
            BitmapLoadUtils.decodeBitmapInBackground(this, getIntent().getData(), null, mMaxBitmapSize, mMaxBitmapSize,
...
//            saveCroppedImage();
            try {
                copyFileToDownloads(filteredBitmap);
            } catch (Exception e) {
                e.printStackTrace();
            }
...
//                    saveCroppedImage();
    ...
    private void saveBitmap(Bitmap bitmap) {
        ...
        String filename = String.format("%d_%s", Calendar.getInstance().getTimeInMillis(), ".png");
        try {
    ...
    private void copyFileToDownloads(Bitmap bitmap) throws Exception {
